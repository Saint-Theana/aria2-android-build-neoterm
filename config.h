...
/* Define build-type */
#define BUILD "aarch64-unknown-linux-gnu"

/* Define to choose default CA bundle. */
#define CA_BUNDLE "/data/user/0/bin.mt.plus/files/term/usr/etc/ca-certificates.crt"
...
/* Define build-type */
#define HOST "aarch64-unknown-linux-android"
...
/* Define target-type */
#define TARGET "aarch64-unknown-linux-android"
